...
Homepage - https://dougiemath-skyeonlineenglish.herokuapp.com/: An issue originally flagged by the [ARC Toolkit](https://chrome.google.com/webstore/detail/arc-toolkit/chdkkkccnlfncngelccgbgfmjebmkmce?hl=en) stated that I needed to add a 'required' attribute to the MailChimp form.  Adding this attribut raised an error with the W3C tool stating that I was not to add the attribute.  As this form is generated by Mail Chimp, and not myself, I have chosen to leave it as it was originally written.  - [error details](media/validation/w3c/home_page_error.jpg)

All Courses - https://dougiemath-skyeonlineenglish.herokuapp.com/courses/: all clear

Course Details - https://dougiemath-skyeonlineenglish.herokuapp.com/courses/7/: A random course was chosen for this test. Result - all clear

Privacy Policy - https://dougiemath-skyeonlineenglish.herokuapp.com/privacy_policy/: all clear

Terms and Conditions - https://dougiemath-skyeonlineenglish.herokuapp.com/terms_and_conditions/: all clear
